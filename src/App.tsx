                  ...
                  <div className="space-y-6">
                    {dynamicRooms.map((room: any, i: number) => (
                      ...
                      >
                        ...
                        {/* Bottom: Content */}
                        <div className="flex flex-col items-center justify-start px-2 pb-2">
                          <h4 className="font-title text-[20px] text-slate-800 leading-tight mb-2 text-center">{room.name}</h4>
                          
                          <div className="bg-[#e1251b] text-white px-4 py-1 rounded-xl mb-4">
                              ...
                              {room.amenities.map((amenity: any, idx: number) => (
                                <div key={idx} className="flex items-center gap-1.5">
                                  ...
                                  <div className="text-slate-500">
                                    {amenity.icon === 'BedDouble' && <BedDouble size={15} strokeWidth={2.5} />}
                                    {amenity.icon === 'Tv' && <Tv size={15} strokeWidth={2.5} />}
                                    {amenity.icon === 'ShowerHead' && <ShowerHead size={15} strokeWidth={2.5} />}
                                    {amenity.icon === 'Wind' && <Wind size={15} strokeWidth={2.5} />}
                                    {amenity.icon === 'Wifi' && <Wifi size={15} strokeWidth={2.5} />}
                                    {amenity.icon === 'Waves' && <Waves size={15} strokeWidth={2.5} />}
                                    {amenity.icon === 'Users' && <Users size={15} strokeWidth={2.5} />}
                                    {amenity.icon === 'Utensils' && <Utensils size={15} strokeWidth={2.5} />}
                                    {amenity.icon === 'Sun' && <Sun size={15} strokeWidth={2.5} />}
                                  </div>
                                </div>
                              ))}
                            </div>
                          ...
                          <div className="w-full mt-auto">
                            <button 
                              ...
                              className="w-full bg-[#25D366] hover:bg-[#20bd5a] text-white rounded-xl font-bold text-[14px] py-3 flex items-center justify-center gap-2 shadow-sm transition-all"
                            >
