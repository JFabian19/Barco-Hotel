                  ...
                  <div className="space-y-4">
                    {dynamicRooms.map((room: any, i: number) => (
                      <motion.div
                        ...
                        key={room.id}
                        className="bg-white rounded-2xl shadow-sm border border-slate-100 flex flex-row overflow-hidden"
                      >
                        ...
                        <div className="w-[42%] shrink-0 relative overflow-hidden">
                          {room.image ? (
                            ...
                            <div className="w-full h-full bg-slate-50 flex items-center justify-center min-h-[180px]">
                        ...
                        <div className="flex-1 flex flex-col justify-between p-3 gap-2">
                          <h4 className="font-title text-[15px] text-slate-800 leading-tight">{room.name}</h4>
                          
                          <div className="self-start bg-[#e1251b] text-white px-3 py-0.5 rounded-lg">
                            ...
                            {room.amenities.map((amenity: any, idx: number) => (
                              <div key={idx} className="flex items-center gap-1">
                                <div className="text-slate-400">
                                  {amenity.icon === 'BedDouble' && <BedDouble size={12} strokeWidth={2.5} />}
                                  {amenity.icon === 'Tv' && <Tv size={12} strokeWidth={2.5} />}
                                  {amenity.icon === 'ShowerHead' && <ShowerHead size={12} strokeWidth={2.5} />}
                                  {amenity.icon === 'Wind' && <Wind size={12} strokeWidth={2.5} />}
                                  {amenity.icon === 'Wifi' && <Wifi size={12} strokeWidth={2.5} />}
                                  {amenity.icon === 'Waves' && <Waves size={12} strokeWidth={2.5} />}
                                  {amenity.icon === 'Users' && <Users size={12} strokeWidth={2.5} />}
                                  {amenity.icon === 'Utensils' && <Utensils size={12} strokeWidth={2.5} />}
                                  {amenity.icon === 'Sun' && <Sun size={12} strokeWidth={2.5} />}
                                </div>
                          ...
                          <button 
                            ...
                            className="w-full bg-[#25D366] hover:bg-[#20bd5a] text-white rounded-lg font-bold text-[12px] py-2 flex items-center justify-center gap-1.5 shadow-sm transition-all mt-auto"
                          >
